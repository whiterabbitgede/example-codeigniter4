...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="https://codeigniter.com/user_guide/" target="_blank" rel="noopener">Docs</a>
            </li>
            <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank" rel="noopener">Community</a></li>
            <li class="menu-item hidden"><a
                    href="https://codeigniter.com/contribute" target="_blank" rel="noopener">Contribute</a>
            </li>
        </ul>
    </div>
...
<div class="further">
    ...
    <section>
        ...
        <p>CodeIgniter is a community-developed open source project, with several
             ...
             target="_blank" rel="noopener">CodeIgniter's forum</a>, or <a href="https://join.slack.com/t/codeigniterchat/shared_invite/zt-rl30zw00-obL1Hr1q1ATvkzVkFp8S0Q"
             target="_blank" rel="noopener">chat on Slack</a> !</p>
        ...
        <p>CodeIgniter is a community driven project and accepts contributions
             ...
             <a href="https://codeigniter.com/contribute" target="_blank" rel="noopener">
             join us</a> ?</p>
